...
void dm_motor_init(void)
{
	...
	{
		motor[i].id = 0x01 + i;
		motor[i].mst_id = 0x00; // 实际没有使用主从关系，只用于识别
...
/**
************************************************************************
* @brief:      	read_all_motor_data: 读取电机各寄存器的参数信息
* @param:      	motor_t 电机控制结构体
* @retval:     	void
* @details:    	依次发送读取指令
************************************************************************
**/
...
/**
************************************************************************
* @brief:      	receive_motor_data: 接收电机返回的参数信息
* @param:      	motor_t 电机控制结构体
* @param:      	data 接收的数据
* @retval:     	void
* @details:    	依次接收电机返回的参数信息
************************************************************************
**/
...
* @param:      	void
* @retval:     	void
* @details:    	当CAN1接收中断回调，根据接收到的ID和数据，执行相应的处理。
*               当收到ID为0x201时，调用dm3519_fbdata处理Motor1的反馈数据。
************************************************************************
**/
